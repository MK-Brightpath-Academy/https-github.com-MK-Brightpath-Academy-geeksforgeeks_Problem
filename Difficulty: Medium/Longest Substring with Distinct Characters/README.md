<h2><a href="https://www.geeksforgeeks.org/problems/longest-distinct-characters-in-string5848/1?page=3&category=Arrays,Strings,Java,Linked%20List&company=Amazon,Microsoft,Google,Flipkart&sortBy=submissions">Longest Substring with Distinct Characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a string <strong>s</strong>, find the length of the longest substring with all distinct<strong> </strong>characters.&nbsp;</span></p>
